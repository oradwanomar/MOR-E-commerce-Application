...
class Products with ChangeNotifier {
  ...
  Map<String, Product> _Wishlists = {};
  Map<String, Product> get getWishlist {
    return _Wishlists;
  }
  ...
  void addToWishlist(
      String prodId, String imgUrl, double price, String brand, String title) {
  ...
  void removeFromWishlist(String prodId) {
    _Wishlists.remove(prodId);
    notifyListeners();
  }

  List<Product> SearchQuery(String searchName) {
